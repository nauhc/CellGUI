...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        adaptThreshSlider->setGeometry(QRect(891, 450, 161, 22));
        ...
        blkSizeSlider->setGeometry(QRect(1101, 450, 161, 22));
        ...
        blkSizeLabel->setGeometry(QRect(1101, 430, 101, 20));
        ...
        drawROIButton->setGeometry(QRect(880, 280, 371, 51));
        ...
        typeComboBox->setGeometry(QRect(880, 110, 371, 35));
        ...
        blebSizeRatioLabel->setGeometry(QRect(1101, 490, 121, 20));
        ...
        groupBox_cellRole->setGeometry(QRect(880, 170, 371, 81));
        ...
        checkBox_compressed->setGeometry(QRect(10, 40, 171, 20));
        ...
        checkBox_control->setGeometry(QRect(230, 40, 131, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_cellRole->setTitle(QApplication::translate("MainWindow", "Cell Role", 0));
